...
public class MagneticMovementPower extends AbstractPower implements CloneablePowerInterface {
    public AbstractCreature source;

    public static final String POWER_ID = DefaultMod.makeID("MagneticMovementPower");
    ...
    public MagneticMovementPower(final AbstractCreature owner, final AbstractCreature source, final int amount) {
        name = NAME;
        ID = POWER_ID;
    ...
    public int onAttacked(DamageInfo info, int damageAmount) {
        ...
        return (int) Math.ceil (damageAmount * .75);
    }

    @Override
    public AbstractPower makeCopy() {
        return new MagneticFlightPower(owner, source, amount);
    }
}
