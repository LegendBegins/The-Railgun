...
public class OverloadPower extends AbstractPower implements CloneablePowerInterface {
    ...
    public static final String POWER_ID = DefaultMod.makeID("OverloadPower");
    ...
    public void atEndOfTurn(final boolean isPlayer) {
        ...
        AbstractDungeon.actionManager.addToBottom (new DamageAction (owner, new DamageInfo(owner, 5, DamageInfo.DamageType.HP_LOSS)));
    ...
    public AbstractPower makeCopy() {
        return new OverloadPower(owner, source, amount);
    }
}
