...
public class LightningSpeedPower extends AbstractPower implements CloneablePowerInterface {
    ...
    public static final String POWER_ID = DefaultMod.makeID("LightningSpeedPower");
    ...
    public LightningSpeedPower(final AbstractCreature owner, final AbstractCreature source, final int amount) {
        name = NAME;
        ID = POWER_ID;
