...
public class MagneticFlightPower extends AbstractPower implements CloneablePowerInterface {
    public AbstractCreature source;

    public static final String POWER_ID = DefaultMod.makeID("MagneticFlightPower");
    ...
    public MagneticFlightPower(final AbstractCreature owner, final AbstractCreature source, final int amount) {
        name = NAME;
        ID = POWER_ID;
    ...
    public int onAttacked(DamageInfo info, int damageAmount) {
        ...
        return (int) Math.ceil (damageAmount * .50);
    }
