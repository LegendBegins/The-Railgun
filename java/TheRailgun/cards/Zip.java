...
public class Zip extends AbstractDynamicCard {

    public static final String ID = DefaultMod.makeID(Zip.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("zip.png");
