...
public class Supercharge extends AbstractDynamicCard {

    public static final String ID = DefaultMod.makeID(Supercharge.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("supercharge.png");
