...
public class Negative_Field extends AbstractDynamicCard {

    public static final String ID = DefaultMod.makeID(Negative_Field.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("negative field.png");
